...
import { TemplatesClient, type TemplateRow } from '../../templates/_components/TemplatesClient'
import type { SectionData } from '../../templates/actions'
...
async function SettingsTemplatesContent() {
  ...
  return <TemplatesClient templates={templates} canManage={canManage(ctx.role)} />
}
